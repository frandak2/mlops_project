# mlops_project guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `mlops_project/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `mlops_project` folder and use the modules inside your notebooks :
...
```python
from mlops_project.utils.paths import data_dir
data_dir()
```
